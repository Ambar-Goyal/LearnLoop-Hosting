...
export default function CourseReviewModal({ setReviewModal }) {
  // Redux: getting user info, token, and course details
  ...
  const onSubmit = async (data) => {
    ...
    setReviewModal(false) // close modal after saving
  }
...
//form hi hai basically by default on clicking save it goes to  onsibmmit funtion 